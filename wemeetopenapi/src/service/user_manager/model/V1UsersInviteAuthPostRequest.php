...
class V1UsersInviteAuthPostRequest implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：
    ...
    public function operatorId(string $operatorId): V1UsersInviteAuthPostRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1UsersInviteAuthPostRequest {
    ...
    public function useridList(array $useridList): V1UsersInviteAuthPostRequest {
