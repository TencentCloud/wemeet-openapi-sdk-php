...
class V1UsersUseridGet200ResponseDepartmentListInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：bool
    ...
    public function departmentName(string $departmentName): V1UsersUseridGet200ResponseDepartmentListInner {
