...
class V1UsersGet200ResponseDepartmentListInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function departmentId(string $departmentId): V1UsersGet200ResponseDepartmentListInner {
    ...
    public function departmentName(string $departmentName): V1UsersGet200ResponseDepartmentListInner {
