...
class V1PmiMeetingsPmiConfigPutRequestHostsInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function isAnonymous(bool $isAnonymous): V1PmiMeetingsPmiConfigPutRequestHostsInner {
    ...
    public function nickName(string $nickName): V1PmiMeetingsPmiConfigPutRequestHostsInner {
    ...
    public function operatorId(string $operatorId): V1PmiMeetingsPmiConfigPutRequestHostsInner {
    ...
    public function operatorIdType(int $operatorIdType): V1PmiMeetingsPmiConfigPutRequestHostsInner {
    ...
    public function profilePhoto(string $profilePhoto): V1PmiMeetingsPmiConfigPutRequestHostsInner {
    ...
    public function userid(string $userid): V1PmiMeetingsPmiConfigPutRequestHostsInner {
        $this->userid = $userid;
        return $this;
    }
