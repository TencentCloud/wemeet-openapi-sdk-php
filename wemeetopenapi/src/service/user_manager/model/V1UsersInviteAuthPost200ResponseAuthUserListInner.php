...
class V1UsersInviteAuthPost200ResponseAuthUserListInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function userid(string $userid): V1UsersInviteAuthPost200ResponseAuthUserListInner {
        $this->userid = $userid;
        return $this;
    }
