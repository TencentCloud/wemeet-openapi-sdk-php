...
class V1MeetingsMeetingIdMsOpenIdGet200Response implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function msOpenId(string $msOpenId): V1MeetingsMeetingIdMsOpenIdGet200Response {
