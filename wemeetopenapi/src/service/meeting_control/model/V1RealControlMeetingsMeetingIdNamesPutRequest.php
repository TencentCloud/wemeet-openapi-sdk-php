...
class V1RealControlMeetingsMeetingIdNamesPutRequest implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：V1RealControlMeetingsMeetingIdNamesPutRequestUsersInner
    ...
    public function operatorId(string $operatorId): V1RealControlMeetingsMeetingIdNamesPutRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1RealControlMeetingsMeetingIdNamesPutRequest {
    ...
    public function users(array $users): V1RealControlMeetingsMeetingIdNamesPutRequest {
        $this->users = $users;
        return $this;
    }
    ...
    protected static $openAPITypes = [
        ...
        'users' => '\wemeet\openapi\service\meeting_control\model\V1RealControlMeetingsMeetingIdNamesPutRequestUsersInner[]'
    ];
