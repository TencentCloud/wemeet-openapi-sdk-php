...
class V1RealControlMeetingsMeetingIdVideoPutRequestUser implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：int
    ...
    public function instanceid(int $instanceid): V1RealControlMeetingsMeetingIdVideoPutRequestUser {
    ...
    public function toOperatorId(string $toOperatorId): V1RealControlMeetingsMeetingIdVideoPutRequestUser {
    ...
    public function toOperatorIdType(int $toOperatorIdType): V1RealControlMeetingsMeetingIdVideoPutRequestUser {
