...
class V1RealControlMeetingsMeetingIdCohostsPutRequestUser implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：int
    ...
    public function instanceid(int $instanceid): V1RealControlMeetingsMeetingIdCohostsPutRequestUser {
    ...
    public function toOperatorId(string $toOperatorId): V1RealControlMeetingsMeetingIdCohostsPutRequestUser {
    ...
    public function toOperatorIdType(int $toOperatorIdType): V1RealControlMeetingsMeetingIdCohostsPutRequestUser {
