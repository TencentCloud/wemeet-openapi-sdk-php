...
class V1RealControlMeetingsMeetingIdScreenSharedPutRequestUser implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：int
    ...
    public function toOperatorId(string $toOperatorId): V1RealControlMeetingsMeetingIdScreenSharedPutRequestUser {
    ...
    public function toOperatorIdType(int $toOperatorIdType): V1RealControlMeetingsMeetingIdScreenSharedPutRequestUser {
