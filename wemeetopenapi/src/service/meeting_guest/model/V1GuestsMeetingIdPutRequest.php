...
class V1GuestsMeetingIdPutRequest implements ModelInterface, \JsonSerializable
{
    /**
     * 会议嘉宾列表（传空数组会清空嘉宾列表）。
    ...
    * 类型：
    ...
    public function guests(array $guests): V1GuestsMeetingIdPutRequest {
        $this->guests = $guests;
        return $this;
    }
    ...
    public function instanceid(int $instanceid): V1GuestsMeetingIdPutRequest {
    ...
    public function userid(string $userid): V1GuestsMeetingIdPutRequest {
        $this->userid = $userid;
        return $this;
    }
