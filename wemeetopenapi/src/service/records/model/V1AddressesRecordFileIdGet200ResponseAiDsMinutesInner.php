...
class V1AddressesRecordFileIdGet200ResponseAiDsMinutesInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function downloadAddress(string $downloadAddress): V1AddressesRecordFileIdGet200ResponseAiDsMinutesInner {
    ...
    public function fileType(string $fileType): V1AddressesRecordFileIdGet200ResponseAiDsMinutesInner {
