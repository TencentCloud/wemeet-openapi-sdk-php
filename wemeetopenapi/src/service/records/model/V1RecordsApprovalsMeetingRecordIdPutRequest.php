...
class V1RecordsApprovalsMeetingRecordIdPutRequest implements ModelInterface, \JsonSerializable
{
    /**
     * 审批动作。 1：同意 2：忽略
    * 类型：
    ...
    * 类型：
    ...
    public function action(int $action): V1RecordsApprovalsMeetingRecordIdPutRequest {
        $this->action = $action;
        return $this;
    }
    ...
    public function operatorIdType(int $operatorIdType): V1RecordsApprovalsMeetingRecordIdPutRequest {
