...
class V1AddressesRecordFileIdGet200ResponseAiMeetingTranscriptsInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function fileType(string $fileType): V1AddressesRecordFileIdGet200ResponseAiMeetingTranscriptsInner {
