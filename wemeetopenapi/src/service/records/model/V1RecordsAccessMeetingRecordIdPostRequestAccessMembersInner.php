...
class V1RecordsAccessMeetingRecordIdPostRequestAccessMembersInner implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：int
    ...
    public function toOperatorId(string $toOperatorId): V1RecordsAccessMeetingRecordIdPostRequestAccessMembersInner {
    ...
    public function toOperatorIdType(int $toOperatorIdType): V1RecordsAccessMeetingRecordIdPostRequestAccessMembersInner {
