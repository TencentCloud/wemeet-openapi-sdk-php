...
class V1RecordsAccessMeetingRecordIdPostRequest implements ModelInterface, \JsonSerializable
{
    /**
     * 成员列表，一次最多传入200个，可以多次调用接口，累加型接口
    * 类型：V1RecordsAccessMeetingRecordIdPostRequestAccessMembersInner
     */
    ...
    * 类型：
    ...
    public function accessMembers(array $accessMembers): V1RecordsAccessMeetingRecordIdPostRequest {
    ...
    public function operatorId(string $operatorId): V1RecordsAccessMeetingRecordIdPostRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1RecordsAccessMeetingRecordIdPostRequest {
    ...
    protected static $openAPITypes = [
        'access_members' => '\wemeet\openapi\service\records\model\V1RecordsAccessMeetingRecordIdPostRequestAccessMembersInner[]',
        'operator_id' => 'string',
