...
class V1MeetingsMeetingIdReleaseRoomsPostRequest implements ModelInterface, \JsonSerializable
{
    /**
     * 会议室ID列表
    * 类型：
    ...
    * 类型：
    ...
    public function meetingRoomIdList(array $meetingRoomIdList): V1MeetingsMeetingIdReleaseRoomsPostRequest {
    ...
    public function operatorId(string $operatorId): V1MeetingsMeetingIdReleaseRoomsPostRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1MeetingsMeetingIdReleaseRoomsPostRequest {
