...
class V1MeetingRoomsRoomConfigInfoPost200ResponseMeetingSettings implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：int
    ...
    public function caption(bool $caption): V1MeetingRoomsRoomConfigInfoPost200ResponseMeetingSettings {
    ...
    public function roomNotification(bool $roomNotification): V1MeetingRoomsRoomConfigInfoPost200ResponseMeetingSettings {
    ...
    public function roomPmi(bool $roomPmi): V1MeetingRoomsRoomConfigInfoPost200ResponseMeetingSettings {
    ...
    protected static $openAPITypes = [
        ...
        'room_pmi' => 'bool',
        'room_pmi_settings' => '\wemeet\openapi\service\meeting_room\model\V1MeetingRoomsRoomConfigInfoPost200ResponseMeetingSettingsRoomPmiSettings',
        'water_mark' => 'int'
    ];
