...
class V1MeetingRoomsRoomCallPutRequest implements ModelInterface, \JsonSerializable
{
    /**
     * 会议ID
    * 类型：
    ...
    * 类型：\wemeet\openapi\service\meeting_room\model\V1MeetingRoomsCancelRoomCallPutRequestMraAddress
    ...
    public function setMeetingId(int $meetingId) {
        $this->meetingId = $meetingId;
    }
    public function meetingRoomId(string $meetingRoomId): V1MeetingRoomsRoomCallPutRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1MeetingRoomsRoomCallPutRequest {
