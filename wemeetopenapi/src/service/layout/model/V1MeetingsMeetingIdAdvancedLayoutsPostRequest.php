...
class V1MeetingsMeetingIdAdvancedLayoutsPostRequest implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：
    ...
    public function layoutList(array $layoutList): V1MeetingsMeetingIdAdvancedLayoutsPostRequest {
    ...
    public function operatorId(string $operatorId): V1MeetingsMeetingIdAdvancedLayoutsPostRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1MeetingsMeetingIdAdvancedLayoutsPostRequest {
    ...
    protected static $openAPITypes = [
        'instanceid' => 'int',
        'layout_list' => '\wemeet\openapi\service\layout\model\V1MeetingsMeetingIdAdvancedLayoutsPostRequestLayoutListInner[]',
        'operator_id' => 'string',
