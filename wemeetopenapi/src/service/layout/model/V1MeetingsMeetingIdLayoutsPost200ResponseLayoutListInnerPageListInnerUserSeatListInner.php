...
class V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function gridType(int $gridType): V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner {
    ...
    public function msOpenId(string $msOpenId): V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner {
    ...
    public function toolSdkid(string $toolSdkid): V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner {
    ...
    public function userid(string $userid): V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner {
        $this->userid = $userid;
        return $this;
    }
    ...
    public function username(string $username): V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner {
    ...
    public function uuid(string $uuid): V1MeetingsMeetingIdLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner {
        $this->uuid = $uuid;
        return $this;
    }
