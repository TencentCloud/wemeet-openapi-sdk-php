...
class V1MeetingsMeetingIdAdvancedLayoutsPost200ResponseLayoutListInnerPageListInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：\wemeet\openapi\service\layout\model\V1MeetingsMeetingIdAdvancedLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner[]
    ...
    public function layoutTemplateId(string $layoutTemplateId): V1MeetingsMeetingIdAdvancedLayoutsPost200ResponseLayoutListInnerPageListInner {
    ...
    protected static $openAPITypes = [
        ...
        'polling_setting' => '\wemeet\openapi\service\layout\model\V1MeetingsMeetingIdAdvancedLayoutsPost200ResponseLayoutListInnerPageListInnerPollingSetting',
        'user_seat_list' => '\wemeet\openapi\service\layout\model\V1MeetingsMeetingIdAdvancedLayoutsPost200ResponseLayoutListInnerPageListInnerUserSeatListInner[]'
    ];
