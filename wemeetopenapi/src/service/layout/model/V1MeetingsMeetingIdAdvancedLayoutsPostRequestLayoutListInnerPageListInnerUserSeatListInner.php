...
class V1MeetingsMeetingIdAdvancedLayoutsPostRequestLayoutListInnerPageListInnerUserSeatListInner implements ModelInterface, \JsonSerializable
{
    /**
     * 宫格 ID
    * 类型：
    ...
    * 类型：int
    ...
    public function gridType(int $gridType): V1MeetingsMeetingIdAdvancedLayoutsPostRequestLayoutListInnerPageListInnerUserSeatListInner {
    ...
    public function userList(array $userList): V1MeetingsMeetingIdAdvancedLayoutsPostRequestLayoutListInnerPageListInnerUserSeatListInner {
    ...
    public function videoType(int $videoType): V1MeetingsMeetingIdAdvancedLayoutsPostRequestLayoutListInnerPageListInnerUserSeatListInner {
    ...
    protected static $openAPITypes = [
        'grid_id' => 'string',
        'grid_type' => 'int',
        'user_list' => '\wemeet\openapi\service\layout\model\V1MeetingsMeetingIdAdvancedLayoutsPostRequestLayoutListInnerPageListInnerUserSeatListInnerUserListInner[]',
        'video_type' => 'int'
    ];
