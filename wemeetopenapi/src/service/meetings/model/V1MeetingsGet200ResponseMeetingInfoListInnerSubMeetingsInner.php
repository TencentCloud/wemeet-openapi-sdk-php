...
class V1MeetingsGet200ResponseMeetingInfoListInnerSubMeetingsInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function startTime(string $startTime): V1MeetingsGet200ResponseMeetingInfoListInnerSubMeetingsInner {
    ...
    public function status(int $status): V1MeetingsGet200ResponseMeetingInfoListInnerSubMeetingsInner {
        $this->status = $status;
        return $this;
    }
    ...
    public function subMeetingId(string $subMeetingId): V1MeetingsGet200ResponseMeetingInfoListInnerSubMeetingsInner {
