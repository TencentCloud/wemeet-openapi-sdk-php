...
class V1MeetingsMeetingIdPutRequestSettings implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：int
    ...
    public function allowInBeforeHost(bool $allowInBeforeHost): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function allowMultiDevice(bool $allowMultiDevice): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function allowScreenSharedWatermark(bool $allowScreenSharedWatermark): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function allowUnmuteSelf(bool $allowUnmuteSelf): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function autoAsr(bool $autoAsr): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function autoInWaitingRoom(bool $autoInWaitingRoom): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function autoRecordType(string $autoRecordType): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function muteEnableJoin(bool $muteEnableJoin): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function muteEnableTypeJoin(int $muteEnableTypeJoin): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function onlyEnterpriseUserAllowed(bool $onlyEnterpriseUserAllowed): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function onlyUserJoinType(int $onlyUserJoinType): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function openAsrView(int $openAsrView): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function playIvrOnJoin(bool $playIvrOnJoin): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function playIvrOnLeave(bool $playIvrOnLeave): V1MeetingsMeetingIdPutRequestSettings {
    ...
    public function waterMarkType(int $waterMarkType): V1MeetingsMeetingIdPutRequestSettings {
