...
class V1MeetingsPost200Response implements ModelInterface, \JsonSerializable
{

    /**
     * 会议列表
    * 类型：\wemeet\openapi\service\meetings\model\V1MeetingsPost200ResponseMeetingInfoListInner[]
     */
    ...
    * 类型：int
    ...
    public function meetingInfoList(array $meetingInfoList): V1MeetingsPost200Response {
    ...
    public function meetingNumber(int $meetingNumber): V1MeetingsPost200Response {
    ...
    protected static $openAPITypes = [
        'meeting_info_list' => '\wemeet\openapi\service\meetings\model\V1MeetingsPost200ResponseMeetingInfoListInner[]',
        'meeting_number' => 'int'
    ];
