...
class V1MeetingsPostRequestHostsInner implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：string
    ...
    public function isAnonymous(bool $isAnonymous): V1MeetingsPostRequestHostsInner {
    ...
    public function nickName(string $nickName): V1MeetingsPostRequestHostsInner {
    ...
    public function userid(string $userid): V1MeetingsPostRequestHostsInner {
        $this->userid = $userid;
        return $this;
    }
