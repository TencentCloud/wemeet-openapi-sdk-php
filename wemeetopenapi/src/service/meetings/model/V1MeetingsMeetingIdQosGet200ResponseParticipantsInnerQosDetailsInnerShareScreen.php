...
class V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function downstreamBitrate(string $downstreamBitrate): V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen {
    ...
    public function downstreamFramerate(string $downstreamFramerate): V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen {
    ...
    public function downstreamResolution(string $downstreamResolution): V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen {
    ...
    public function upstreamBitrate(string $upstreamBitrate): V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen {
    ...
    public function upstreamFramerate(string $upstreamFramerate): V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen {
    ...
    public function upstreamResolution(string $upstreamResolution): V1MeetingsMeetingIdQosGet200ResponseParticipantsInnerQosDetailsInnerShareScreen {
