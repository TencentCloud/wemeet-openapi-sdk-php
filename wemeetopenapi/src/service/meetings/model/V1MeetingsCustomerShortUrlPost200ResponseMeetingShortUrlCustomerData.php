...
class V1MeetingsCustomerShortUrlPost200ResponseMeetingShortUrlCustomerData implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function customerData(string $customerData): V1MeetingsCustomerShortUrlPost200ResponseMeetingShortUrlCustomerData {
    ...
    public function meetingShortUrl(string $meetingShortUrl): V1MeetingsCustomerShortUrlPost200ResponseMeetingShortUrlCustomerData {
