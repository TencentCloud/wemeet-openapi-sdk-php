...
class V1MeetingsPostRequestSettings implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：bool
    ...
    /**
     * 入会后自动开启文字转写，默认为 false。 true：自动开启转写 false：自动关闭转写
    * 类型：bool
     */
    ...
    * 类型：int
    ...
    /**
     * 设置主持人入会是否自动打开转写侧边栏 在auto_asr为true下才会生效，0是默认开启，1是关闭
    * 类型：int
     */
    ...
    * 类型：int
    ...
    public function autoAsr(bool $autoAsr): V1MeetingsPostRequestSettings {
    ...
    public function openAsrView(int $openAsrView): V1MeetingsPostRequestSettings {
