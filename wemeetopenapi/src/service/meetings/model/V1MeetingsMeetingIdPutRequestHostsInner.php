...
class V1MeetingsMeetingIdPutRequestHostsInner implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：string
    ...
    public function nickName(string $nickName): V1MeetingsMeetingIdPutRequestHostsInner {
    ...
    public function userid(string $userid): V1MeetingsMeetingIdPutRequestHostsInner {
        $this->userid = $userid;
        return $this;
    }
