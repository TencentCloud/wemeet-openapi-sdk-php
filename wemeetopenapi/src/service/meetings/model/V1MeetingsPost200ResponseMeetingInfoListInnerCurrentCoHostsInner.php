...
class V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function isAnonymous(bool $isAnonymous): V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner {
    ...
    public function nickName(string $nickName): V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner {
    ...
    public function operatorId(string $operatorId): V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner {
    ...
    public function operatorIdType(int $operatorIdType): V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner {
    ...
    public function profilePhoto(string $profilePhoto): V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner {
    ...
    public function userid(string $userid): V1MeetingsPost200ResponseMeetingInfoListInnerCurrentCoHostsInner {
        $this->userid = $userid;
        return $this;
    }
