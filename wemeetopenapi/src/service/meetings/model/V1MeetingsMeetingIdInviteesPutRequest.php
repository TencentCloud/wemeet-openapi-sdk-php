...
class V1MeetingsMeetingIdInviteesPutRequest implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdInviteesPutRequestInviteesInner[]
     */
    ...
    public function instanceid(int $instanceid): V1MeetingsMeetingIdInviteesPutRequest {
    ...
    public function invitees(array $invitees): V1MeetingsMeetingIdInviteesPutRequest {
    ...
    public function userid(string $userid): V1MeetingsMeetingIdInviteesPutRequest {
        $this->userid = $userid;
        return $this;
    }
    ...
    protected static $openAPITypes = [
        'instanceid' => 'int',
        'invitees' => '\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdInviteesPutRequestInviteesInner[]',
        'userid' => 'string'
    ];
