...
class V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    /**
     * 等候室人员对象数组
    * 类型：\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdWaitingRoomParticipantsGet200ResponseParticipantsInner[]
     */
    ...
    * 类型：int
    ...
    public function currentPage(int $currentPage): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function currentSize(int $currentSize): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function meetingCode(string $meetingCode): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function meetingId(string $meetingId): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function participants(array $participants): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function scheduleEndTime(int $scheduleEndTime): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function scheduleStartTime(int $scheduleStartTime): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function subject(string $subject): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function totalCount(int $totalCount): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    public function totalPage(int $totalPage): V1MeetingsMeetingIdWaitingRoomParticipantsGet200Response {
    ...
    protected static $openAPITypes = [
        ...
        'meeting_code' => 'string',
        'meeting_id' => 'string',
        'participants' => '\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdWaitingRoomParticipantsGet200ResponseParticipantsInner[]',
