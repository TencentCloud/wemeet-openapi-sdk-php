...
class V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：int
    ...
    public function customizedRecurringStep(int $customizedRecurringStep): V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule {
    ...
    public function customizedRecurringType(int $customizedRecurringType): V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule {
    ...
    public function recurringType(int $recurringType): V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule {
    ...
    public function untilCount(int $untilCount): V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule {
    ...
    public function untilDate(int $untilDate): V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule {
    ...
    public function untilType(int $untilType): V1MeetingsGet200ResponseMeetingInfoListInnerRecurringRule {
