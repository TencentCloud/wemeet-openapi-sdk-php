...
class V1MeetingsMeetingIdInviteesPut200Response implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string[]
    ...
    public function userNonRegistered(array $userNonRegistered): V1MeetingsMeetingIdInviteesPut200Response {
