...
class V1MeetingsMeetingIdPutRequestLiveConfig implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    /**
    * 类型：\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark
     */
    ...
    public function __construct(
        ...
        if (isset($jsonArray['live_watermark'])) {
            $this->liveWatermark = new V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark($jsonArray['live_watermark']);
        }
    }

    public function enableLiveIm(bool $enableLiveIm): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function enableLivePassword(bool $enableLivePassword): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function enableLiveReplay(bool $enableLiveReplay): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function livePassword(string $livePassword): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function liveSubject(string $liveSubject): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function liveSummary(string $liveSummary): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function liveWatermark(V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark $liveWatermark): V1MeetingsMeetingIdPutRequestLiveConfig {
    ...
    public function setLiveWatermark(V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark $liveWatermark) {
        $this->liveWatermark = $liveWatermark;
    }
    ...
    protected static $openAPITypes = [
        ...
        'live_subject' => 'string',
        'live_summary' => 'string',
        'live_watermark' => '\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdPutRequestLiveConfigLiveWatermark'
    ];
