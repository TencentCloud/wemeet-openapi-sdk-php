...
class V1MeetingsPostRequestInviteesInner implements ModelInterface, \JsonSerializable
{
    /**
    ...
    * 类型：string
    ...
    public function isAnonymous(bool $isAnonymous): V1MeetingsPostRequestInviteesInner {
    ...
    public function nickName(string $nickName): V1MeetingsPostRequestInviteesInner {
    ...
    public function userid(string $userid): V1MeetingsPostRequestInviteesInner {
        $this->userid = $userid;
        return $this;
    }
