...
class V1MeetingsMeetingIdEnrollUnregistrationDeleteRequest implements ModelInterface, \JsonSerializable
{
    /**
     * 报名对象列表
    ...
    * 类型：
    ...
    public function instanceid(int $instanceid): V1MeetingsMeetingIdEnrollUnregistrationDeleteRequest {
    ...
    public function operatorId(string $operatorId): V1MeetingsMeetingIdEnrollUnregistrationDeleteRequest {
    ...
    public function operatorIdType(int $operatorIdType): V1MeetingsMeetingIdEnrollUnregistrationDeleteRequest {
    ...
    protected static $openAPITypes = [
        'enroll_id_list' => '\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdEnrollUnregistrationDeleteRequestEnrollIdListInner[]',
        'instanceid' => 'int',
        'operator_id' => 'string',
