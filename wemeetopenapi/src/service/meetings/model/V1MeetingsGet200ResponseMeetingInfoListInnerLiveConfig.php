...
class V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：\wemeet\openapi\service\meetings\model\V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfigLiveWatermark
    ...
    public function enableLiveIm(bool $enableLiveIm): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function enableLivePassword(bool $enableLivePassword): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function enableLiveReplay(bool $enableLiveReplay): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function liveAddr(string $liveAddr): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function livePassword(string $livePassword): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function liveSubject(string $liveSubject): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function liveSummary(string $liveSummary): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
    ...
    public function liveWatermark(V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfigLiveWatermark $liveWatermark): V1MeetingsGet200ResponseMeetingInfoListInnerLiveConfig {
