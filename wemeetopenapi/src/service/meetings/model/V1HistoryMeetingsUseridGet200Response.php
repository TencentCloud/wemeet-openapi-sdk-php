...
class V1HistoryMeetingsUseridGet200Response implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：int
    ...
    /**
    * 类型：\wemeet\openapi\service\meetings\model\V1HistoryMeetingsUseridGet200ResponseMeetingInfoListInner[]
     */
    ...
    * 类型：int
    ...
    public function currentPage(int $currentPage): V1HistoryMeetingsUseridGet200Response {
    ...
    public function currentSize(int $currentSize): V1HistoryMeetingsUseridGet200Response {
    ...
    public function meetingInfoList(array $meetingInfoList): V1HistoryMeetingsUseridGet200Response {
    ...
    public function totalCount(int $totalCount): V1HistoryMeetingsUseridGet200Response {
    ...
    public function totalPage(int $totalPage): V1HistoryMeetingsUseridGet200Response {
    ...
    protected static $openAPITypes = [
        'current_page' => 'int',
        'current_size' => 'int',
        'meeting_info_list' => '\wemeet\openapi\service\meetings\model\V1HistoryMeetingsUseridGet200ResponseMeetingInfoListInner[]',
        'total_count' => 'int',
        'total_page' => 'int'
    ];
