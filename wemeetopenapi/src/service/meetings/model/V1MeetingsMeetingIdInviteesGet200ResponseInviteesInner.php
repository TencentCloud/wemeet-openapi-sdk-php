...
class V1MeetingsMeetingIdInviteesGet200ResponseInviteesInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function userid(string $userid): V1MeetingsMeetingIdInviteesGet200ResponseInviteesInner {
        $this->userid = $userid;
        return $this;
    }
