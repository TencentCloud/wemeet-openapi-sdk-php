...
class V1MeetingsMeetingIdEnrollConfigPutRequestQuestionListInner implements ModelInterface, \JsonSerializable
{
    /**
     * 是否必填：1 否，2 是
    * 类型：
    ...
    * 类型：int
    ...
    public function optionList(array $optionList): V1MeetingsMeetingIdEnrollConfigPutRequestQuestionListInner {
    ...
    public function questionTitle(string $questionTitle): V1MeetingsMeetingIdEnrollConfigPutRequestQuestionListInner {
    ...
    public function questionType(int $questionType): V1MeetingsMeetingIdEnrollConfigPutRequestQuestionListInner {
    ...
    public function specialType(int $specialType): V1MeetingsMeetingIdEnrollConfigPutRequestQuestionListInner {
    ...
    protected static $openAPITypes = [
        'is_required' => 'int',
        'option_list' => '\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdEnrollConfigPutRequestQuestionListInnerOptionListInner[]',
