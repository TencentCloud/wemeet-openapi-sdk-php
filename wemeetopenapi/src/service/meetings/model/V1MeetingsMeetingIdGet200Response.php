...
class V1MeetingsMeetingIdGet200Response implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：int
    ...
    public function meetingNumber(int $meetingNumber): V1MeetingsMeetingIdGet200Response {
    ...
    protected static $openAPITypes = [
        'meeting_info_list' => '\wemeet\openapi\service\meetings\model\V1MeetingsMeetingIdGet200ResponseMeetingInfoListInner[]',
        'meeting_number' => 'int'
    ];
