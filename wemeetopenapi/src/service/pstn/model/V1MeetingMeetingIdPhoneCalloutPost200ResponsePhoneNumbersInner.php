...
class V1MeetingMeetingIdPhoneCalloutPost200ResponsePhoneNumbersInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function area(int $area): V1MeetingMeetingIdPhoneCalloutPost200ResponsePhoneNumbersInner {
        $this->area = $area;
        return $this;
    }
    ...
    public function extensionNumber(string $extensionNumber): V1MeetingMeetingIdPhoneCalloutPost200ResponsePhoneNumbersInner {
    ...
    public function phone(string $phone): V1MeetingMeetingIdPhoneCalloutPost200ResponsePhoneNumbersInner {
        $this->phone = $phone;
        return $this;
    }
    ...
    public function status(string $status): V1MeetingMeetingIdPhoneCalloutPost200ResponsePhoneNumbersInner {
        $this->status = $status;
        return $this;
    }
