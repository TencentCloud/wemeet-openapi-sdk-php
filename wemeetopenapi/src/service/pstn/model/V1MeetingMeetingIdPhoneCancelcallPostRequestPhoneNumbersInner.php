...
class V1MeetingMeetingIdPhoneCancelcallPostRequestPhoneNumbersInner implements ModelInterface, \JsonSerializable
{
    /**
     * 国家/地区代码。（例如：中国是86）
    * 类型：
    ...
    * 类型：string
    ...
    public function area(int $area): V1MeetingMeetingIdPhoneCancelcallPostRequestPhoneNumbersInner {
        $this->area = $area;
        return $this;
    }
    ...
    public function extensionNumber(string $extensionNumber): V1MeetingMeetingIdPhoneCancelcallPostRequestPhoneNumbersInner {
    ...
    public function phone(string $phone): V1MeetingMeetingIdPhoneCancelcallPostRequestPhoneNumbersInner {
        $this->phone = $phone;
        return $this;
    }
