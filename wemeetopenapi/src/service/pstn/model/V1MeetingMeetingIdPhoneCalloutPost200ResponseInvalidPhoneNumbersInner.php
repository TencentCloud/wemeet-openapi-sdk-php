...
class V1MeetingMeetingIdPhoneCalloutPost200ResponseInvalidPhoneNumbersInner implements ModelInterface, \JsonSerializable
{
    ...
    * 类型：string
    ...
    public function area(int $area): V1MeetingMeetingIdPhoneCalloutPost200ResponseInvalidPhoneNumbersInner {
        $this->area = $area;
        return $this;
    }
    ...
    public function phone(string $phone): V1MeetingMeetingIdPhoneCalloutPost200ResponseInvalidPhoneNumbersInner {
        $this->phone = $phone;
        return $this;
    }
